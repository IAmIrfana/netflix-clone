...
const Ticketpage = ({ setToggleTicket }) => {
    ...
    return (
        <div className='  top-10  z-40 absolute  bg-black  '>
            {toggleSeat && <div className="w-full bg-black/75 absolute z-20 h-full"></div>}

            <div className='text-2xl flex justify-between m-7'>
                <h1 className='font-semibold'>Buy Tickets
                </h1>
                <button onClick={() => setToggleTicket(false)}><BsArrowLeft /></button>
            </div>
            ...
            <div>
                ...
                <div className='py-6 ml-7'>
                    <h1 className='text-2xl font- py-3'>Number of Tickets</h1>
                    <div className='text-xl bg-red-600 w-[60vh] px-10 p-2 rounded-xl font-semibold  '>
                        <h2 className='flex gap-1'><BiBookmarkAltPlus className='text-4xl' />FESTIVE Discount </h2>
                        <h1>30% Off evening tickets</h1>
            ...
            <div className=''>
                <button className=' bg-red-600 w-[65vh] h-[10vh] font-bold text-xl rounded-2xl ml-16 m-5' onClick={() => setToggleSeat(true)}> Next</button>
            </div>
            <div className="flex justify-center">
                {toggleSeat && <SelectSeat setToggleSeat={setToggleSeat} />}
            </div>
